  ...
  ;(() => {
    ...
    var Bc = S((pH, wc) => {
      ...
      function HD(e, t, r, n, a, o) {
        ...
        if (m && !y) return o || (o = new go()), i || jD(e) ? ND(e, t, r, n, a, o) : LD(e, t, s, r, n, a, o)
        if (!(r & qD)) {
    ...
    var st = S((iJ, dh) => {
      ...
      var Yo = function () {
        ...
        Ct = {
          ...
          '%MapIteratorPrototype%': typeof Map > 'u' || !Gt || !Ae ? ee : Ae(new Map()[Symbol.iterator]()),
          '%Math%': Math,
          '%Number%': Number,
          '%Object%': Object,
          ...
          '%SetIteratorPrototype%': typeof Set > 'u' || !Gt || !Ae ? ee : Ae(new Set()[Symbol.iterator]()),
    ...
    var Qh = S((jJ, Jh) => {
      ...
      Jh.exports = function e(t, r, n, a) {
        ...
        if (p_(t)) {
          for (var x = '<' + Nh.call(String(t.nodeName)), F = t.attributes || [], B = 0; B < F.length; B++)
        ...
        if (!ZT(t) && !Uh(t)) {
          ...
          return k.length === 0 ? X + '{}' : A ? X + '{' + ci(k, A) + '}' : X + '{ ' + We.call(k, ', ') + ' }'
        }
        return String(t)
      }
      function Vh(e, t, r) {
    ...
    var lm = S((tQ, sm) => {
      ...
      var im = em(),
        ...
        z_ = function e(t, r, n, a, o, i, u, s, p, y, A, m, h, E, b, x) {
          ...
          var U
          if (n === 'comma' && Ze(F))
            E && u && (F = Qn.maybeMap(F, u)), (U = [{ value: F.length > 0 ? F.join(',') || null : void 0 }])
          else if (Ze(s)) U = s
          else {
            var V = Object.keys(F)
            U = p ? V.sort(p) : V
          ...
          for (var H = a && Ze(F) && F.length === 1 ? r + '[]' : r, oe = 0; oe < U.length; ++oe) {
            ...
            if (!(i && Y === null)) {
              var R = Ze(F) ? (typeof n == 'function' ? n(H, X) : H) : H + (y ? '.' + X : '[' + X + ']')
              x.set(t, I)
              var _ = im()
              _.set(Ei, x),
                um(k, e(Y, R, n, a, o, i, n === 'comma' && E && Ze(F) ? null : u, s, p, y, A, m, h, E, b, _))
            }
          }
          return k
        },
...
`
        ...
        function R() {
          ...
          return (
            (T = X()),
            i === t.DOT_LT || i === t.LT
              ? (M(), (P = Y()), N(t.GT), E({ type: e.TypeApplication, expression: T, applications: P }, [L, o]))
              : T
          )
        }
        function _() {
          ...
          return (
            ...
            i !== t.RPAREN &&
              (i === t.NAME && (u === 'this' || u === 'new')
                ? ((T = u === 'new'), w(t.NAME), N(t.COLON), (P = R()), i === t.COMMA && (w(t.COMMA), (L = q())))
                : (L = q())),
            N(t.RPAREN),
            (O = null),
            i === t.COLON && (O = _()),
        ...
        function K() {
          ...
          return i === t.QUESTION
            ...
            : i === t.BANG
            ? ((P = a - 1), w(t.BANG), E({ type: e.NonNullableType, expression: J(), prefix: !0 }, [P, o]))
            : ((P = o),
              (T = J()),
              i === t.BANG
            ...
            (Q.prototype.parse = function () {
              ...
              for (
                this._last = G(this._title),
                  this._options.range &&
                    (this._tag.range = [this._first, H.slice(0, this._last).replace(/\s*$/, '').length].map(Ie)),
                  a(N, this._title)
                    ? (z = N[this._title])
    ...
    var Zm = S((Vee, Qm) => {
      ...
      Qm.exports = function (e) {
        ...
        function y(B) {
          ...
          return (
            B && ((w = w + i + e.collapsibleClass), (w = w + i + e.isCollapsedClass)), M.setAttribute('class', w), M
          )
        }
        function A() {
    ...
    var Og = S((Ste, _g) => {
      ...
      function jR(e, t) {
        let r = [t[e].parent, e],
          n = ia[t[e].parent][e],
          a = t[e].parent
        for (; t[a].parent; ) r.unshift(t[a].parent), (n = MR(ia[t[a].parent][a], n)), (a = t[a].parent)
...
`,
                ...
                let I = (function (k) {
                  ...
                  N = (b[w] = (function (k, U) {
                    return k === 'style'
                      ...
                      : k === 'href'
                      ? Ht(U)
                      : (U.match($S) && (U = U.slice(1, U.length - 1)), U === 'true' || (U !== 'false' && U))
                  })(I, M))
                typeof N == 'string' && (Io.test(N) || ko.test(N)) && (b[w] = he(a(N.trim()), { key: F }))
      ...
      let i = [],
        ...
        s = {
          ...
          codeInline: { t: ut(RS), i: te.LOW, l: (h) => ({ v: h[2] }), h: (h, E, b) => n('code', { key: b.k }, h.v) },
...
`,
          ...
          text: {
            t: wr(lF),
            i: te.MIN,
            l: (h) => ({ v: h[0].replace(jS, (E, b) => (t.namedCodesToUnicode[b] ? t.namedCodesToUnicode[b] : E)) }),
            h: (h) => h.v,
          },
          textBolded: {
            t: ut(aF),
          ...
          textMarked: { t: ut(iF), i: te.LOW, l: _o, h: (h, E, b) => n('mark', { key: b.k }, E(h.v, b)) },
          textStrikethroughed: { t: ut(uF), i: te.LOW, l: _o, h: (h, E, b) => n('del', { key: b.k }, E(h.v, b)) },
        }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
          ...
          function X(R, _, q) {
            return _ !== 'text' && ((R = R.filter(I(M(q)))), R.push({ token: _, data: q, category: M(q) })), R
          }
          var Y = (function () {
            function R(_) {
              r(this, R),
          ...
          t.exports = function (Y, R) {
            ...
            for (var Pe = 1, Ie = !0; Pe < _.length; Pe += 1) {
              var Q = _[Pe],
                je = N(Q, 0, 1),
                T = N(Q, -1)
              if ((je === '"' || je === "'" || je === '`' || T === '"' || T === "'" || T === '`') && je !== T)
                throw new n('property names with quotes must have matching quotes')
              if (((Q === 'constructor' || !Ie) && (Z = !0), (q += '.' + Q), (J = '%' + q + '%'), B(E, J))) K = E[J]
              else if (K != null) {
                if (!(Q in K)) {
                ...
                if (u && Pe + 1 >= _.length) {
                  var P = u(K, Q)
                  ;(Ie = !!P), Ie && 'get' in P && !('originalValue' in P.get) ? (K = P.get) : (K = K[Q])
                } else (Ie = B(K, Q)), (K = K[Q])
                Ie && !Z && (E[J] = K)
              }
            }
...
` &&
    ...
    var fa = (e) => ({
      ...
      N4 = j(Da)({ position: 'absolute', left: 0, right: 0, top: 0, transition: 'transform .2s linear' }),
    ...
    var U4 = j(L4)({ position: 'absolute', top: 0, left: 0, right: 0, height: 40 }),
      ...
      G4 = ({
        ...
        let [A, m] = re(i),
          ...
          { window: N } = ue,
          k = ge(async (V) => {
            let { createCopyToClipboardFunction: H } = await Promise.resolve().then(() => (cr(), yu))
            H()
          }, []),
          U = (V) => {
    ...
    var Iy = class extends et {
      ...
      render() {
        ...
        if (r && !B) {
          ...
          ;(x = g.createElement('span', { className: 'rejt-edit-form', style: b.editForm }, N, ' ', w, M)), (F = null)
        } else {
          x = g.createElement(
            'span',
    ...
    var pt = class extends et {
      ...
      render() {
        ...
        return g.createElement(
          ...
          g.createElement('span', { className: 'rejt-name', style: b.name }, e, ' : '),
          F
            ? g.createElement('span', { className: 'rejt-edit-form', style: b.editForm }, w, ' ', M, I)
            : g.createElement(
                'span',
    ...
    var eP = ({ name: e, value: t, onChange: r, min: n = 0, max: a = 100, step: o = 1, onBlur: i, onFocus: u }) => {
      ...
      rP = j.div(({ isMaxed: e }) => ({ marginLeft: '0.75rem', paddingTop: '0.35rem', color: e ? 'red' : void 0 })),
    ...
    var iP = ({ onChange: e, name: t, accept: r = 'image/*', value: n }) => {
      ...
      pP = j.span(({ theme: e }) => ({ color: e.color.negative, fontFamily: e.typography.fonts.mono, cursor: 'help' })),
      fP = j.div(({ theme: e }) => ({
      ...
      gP = j.td(({ theme: e, expandable: t }) => ({ paddingLeft: t ? '40px !important' : '20px !important' })),
      da = (e) => {
        let [t, r] = re(!1),
      ...
      bP = j.span(({ theme: e }) => ({ display: 'flex', lineHeight: '20px', alignItems: 'center' })),
      EP = j.td(({ theme: e }) => ({
        position: 'relative',
      ...
      BP = j.div(({ theme: e }) => ({ display: 'flex', fontSize: e.typography.size.s2 - 1, gap: 25 })),
        ...
        return g.createElement(
          ...
          g.createElement(
            ...
            g.createElement(
              ...
              A.ungrouped.map((B) => g.createElement(da, { key: B.key, row: B, arg: p && p[B.key], ...F })),
              Object.entries(A.ungroupedSubsections).map(([B, I]) =>
                g.createElement(
                  zi,
                  { key: B, label: B, level: 'subsection', colSpan: b },
                  I.map((M) => g.createElement(da, { key: M.key, row: M, arg: p && p[M.key], expandable: x, ...F })),
                ),
              ),
              Object.entries(A.sections).map(([B, I]) =>
                g.createElement(
                  ...
                  I.ungrouped.map((M) => g.createElement(da, { key: M.key, row: M, arg: p && p[M.key], ...F })),
                  Object.entries(I.subsections).map(([M, w]) =>
                    g.createElement(
                      zi,
                      { key: M, label: M, level: 'subsection', colSpan: b },
                      w.map((N) =>
                        g.createElement(da, { key: N.key, row: N, arg: p && p[N.key], expandable: x, ...F }),
                      ),
                    ),
                  ),
                ),
      ...
      Lre = j.div(Tt, ({ theme: e }) => ({ ...fa(e), margin: '25px 0 40px', padding: '30px 20px' }))
    var Mre = j.div(({ theme: e }) => ({ fontWeight: e.typography.weight.bold, color: e.color.defaultText })),
      ...
      Gre = j.div({ display: 'flex', flexDirection: 'column', flex: 1, position: 'relative', marginBottom: 30 }),
    ...
    var qP = (e, t) => {
      ...
      Ki = (e, t, r, n, a, o) => ({ ...e, ...(0, Ay.default)(t, (i) => ({ rows: jy(i, r, n, a), sort: o })) }),
      UP = (e) => {
        let t = Xr(Qi),
        ...
        try {
          ...
          if (
            (B || ((m = null), (h = null), (F = {})), n && (!B || o) && (F = Ki(F, { [x]: n }, y.parameters, i, u)), a)
          ) {
            if (Array.isArray(a))
              throw new Error(
  ...
  `)
    ...
    var one = j.div(({ theme: e }) => ({ width: '10rem', '@media (max-width: 768px)': { display: 'none' } })),
      ine = j.div(({ theme: e }) => ({
        position: 'fixed',
        bottom: 0,
        top: 0,
