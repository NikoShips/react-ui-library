import { c as Bu, g as ju } from './_commonjsHelpers-725317a4.js'
function Ar(u, e) {
...
var B0 = eu,
  ...
  y0 = Ku
function d0() {
  ;(this.size = 0), (this.__data__ = { hash: new te(), map: new (y0 || h0)(), string: new te() })
}
var v0 = d0
function g0(u) {
  var e = typeof u
...
function V0(u, e) {
  ...
  if (r instanceof H0) {
    var t = r.__data__
    if (!q0 || t.length < z0 - 1) return t.push([u, e]), (this.size = ++r.size), this
...
function Ts(u, e, r, t, a, i) {
  ...
  if (F && !T) return i || (i = new Pu()), n || ms(u) ? ds(u, e, r, t, a, i) : vs(u, e, p, r, t, a, i)
  if (!(r & _s)) {
...
function Ju(u, e) {
  if (typeof u != 'function' || (e != null && typeof e != 'function')) throw new TypeError(tD)
  var r = function () {
    var t = arguments,
...
`
  ...
  function f() {
    ...
    for (_(e.LBRACK, 'ArrayType should start with ['), s = []; n !== e.RBRACK; ) {
      if (n === e.REST) {
        ;(y = a - 3), _(e.REST), s.push(d({ type: u.RestType, expression: j() }, [y, i]))
        break
      } else s.push(j())
    ...
    for (var s = [], D = !1, y, o = !1, A, h = a - 3, v; n !== e.RPAREN; )
      n === e.REST && (_(e.REST), (o = !0)),
        ...
        y.type === u.NameExpression &&
          ...
          ((v = i - y.name.length),
          _(e.COLON),
          (y = d({ type: u.ParameterType, name: y.name, expression: j() }, [v, i]))),
        n === e.EQUAL
...
\u2028\u2029])`
    ...
    function _(C, k) {
      for (var f = C.replace(/^\/\*\*?/, ''), U = 0, G = new RegExp(z, 'g'), g; (g = G.exec(f)); )
        if (((U += g[1].length), g.index + g[0].length > k + U)) return k + U + C.length - f.length
    ...
    ;(function (C) {
      ...
      function $() {
        ...
        return (
          (f += 1),
          a.code.isLineTerminator(o) && !(o === 13 && g.charCodeAt(f) === 10) && (U += 1),
      ...
      function y(o, A) {
        ...
        for (
          G = g.length, f = 0, U = 0, Eu = A.recoverable, V = A.sloppy, pu = A.strict, N = D(A.preserveWhitespace);
          (v = s(A)), !!v;
      ...
      case 'union':
        ...
        return (
          u.elements.every((i) => i.name === 'literal')
            ? (a = { ...t, name: 'enum', value: u.elements.map((i) => er(i.value)) })
...
var wA = { tags: ['param', 'arg', 'argument', 'returns', 'ignore', 'deprecated'] },
  OA = (u, e = wA) => {
...
var Co = (u) => {
  ...
  io = ((u) => ((u.AUTO = 'auto'), (u.CODE = 'code'), (u.DYNAMIC = 'dynamic'), u))(io || {})
export {
  gi as A,
  yi as B,
  Li as C,
